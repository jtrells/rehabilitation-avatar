...
public class WandControls : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (CAVE2Manager.GetButtonDown(1, CAVE2Manager.Button.Button7) || Input.GetKeyDown(KeyCode.F1))
        {      // L2
        ...
        else if (CAVE2Manager.GetButtonDown(1, CAVE2Manager.Button.Button2) || Input.GetKeyDown(KeyCode.C))
        {  // Circle
            if (ControlBouncing())
            {
        ...
        {
            SessionManager.GetInstance().StartNewTraining(4);
        }
    }
